...
const mutations = {
  ...
  /**
   * User/Account
   * Atualiza as informações do usuário no  state e localstorage.
   *
   * @param state
   * @param payload
   * @constructor
  ...
  UPDATE_USER_INFO(state, payload) {
    ...
    for (const property of Object.keys(payload)) {
      ...
      if (payload[property] != null) {
        //Se alguma propriedade do usuário for nula - a propriedade default do usuário é definida em state.AppActiveUser
